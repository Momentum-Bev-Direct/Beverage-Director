...
def homepage(request):
    ...
    for cocktail in cocktails:
        ...
        cocktail_dict["shots"]= {
            str(shot.pk):{"volume":shot.volume, "cost": shot.spirit.price_per_oz, "brandname": shot.spirit.brandname} for shot in cocktail.shots.all()
        }
...
def edit_cocktail(request, pk):
    ...
    cocktail_dict["shots"]= {
        str(shot.pk):{"id":shot.pk, "volume":shot.volume, "cost": shot.spirit.price_per_oz, "brandname": shot.spirit.brandname} for shot in cocktail.shots.all()
    }
